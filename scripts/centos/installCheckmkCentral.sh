...
#su - dev -c "omd start"
omd start dev
/bin/cp /vagrant/conf/check_mk/main.mk.central /opt/omd/sites/dev/etc/check_mk/main.mk
/bin/cp --preserve=mode /vagrant/conf/check_mk/sites.mk /opt/omd/sites/dev/etc/check_mk/multisite.d/
/bin/chown dev.dev /opt/omd/sites/dev/etc/check_mk/multisite.d/sites.mk
